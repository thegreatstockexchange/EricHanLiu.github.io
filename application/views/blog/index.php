...
<head>
    ...
    <body>
        ...
        <div class="container">
                ...
                foreach($posts as $post) {?>
                    <div class="row">
                        <div class="col-md-7 col-xs-10">
                            ...
                            <br><button type="button" class="btn btn-default btn-xs leaveComment glyphicon glyphicon-comment"></button>
            ...
            <div id="toTop">
                <a onclick="scrollz()" class="glyphicon glyphicon-menu-up"></a>
            </div>
        </div>
